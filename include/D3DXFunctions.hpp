 ...
 * @param B
 */
D3DXINLINE D3DXVECTOR3 *D3DXVec3Cross(D3DXVECTOR3 *pOut, const D3DXVECTOR3 *A, const D3DXVECTOR3 *B)
{
 ...
 * @return
 */
D3DXINLINE float D3DXVec2Dot(const D3DXVECTOR2 *a, const D3DXVECTOR2 *b)
{
    return (a->x * b->x +
        a->y * b->y);
}
 ...
 * @return
 */
D3DXINLINE float D3DXVec3Dot(const D3DXVECTOR3 *a, const D3DXVECTOR3 *b)
{
    return (a->x * b->x +
        a->y * b->y +
        a->z * b->z);
 ...
 * @return
 */
D3DXINLINE float D3DXVec4Dot(const D3DXVECTOR4 *a, const D3DXVECTOR4 *b)
{
    return (a->x * b->x +
        a->y * b->y +
        a->z * b->z +
 ...
 * @return
 */
D3DXINLINE D3DXVECTOR2 *D3DXVec2Normalize(D3DXVECTOR2 *pOut, const D3DXVECTOR2 *pV)
{
...
D3DXINLINE D3DXVECTOR2 *D3DXVec2Normalize(D3DXVECTOR2 *pOut)
{
 ...
 * @return
 */
D3DXINLINE D3DXVECTOR3 *D3DXVec3Normalize(D3DXVECTOR3 *pOut, const D3DXVECTOR3 *pV)
{
#ifdef D3DX_NORMALIZATION_POINTER_CHECK
    if (pOut == NULL) {
        pOut = new D3DXVECTOR3();
 ...
 * @return
 */
D3DXINLINE D3DXVECTOR3 *D3DXVec3Normalize(D3DXVECTOR3 *pOut)
{
 ...
 * @return
 */
D3DXINLINE float D3DXVec3Normalize2(D3DXVECTOR3 *pOut)
{
    float length = (pOut->x * pOut->x +
        pOut->z * pOut->z +
        pOut->y * pOut->y);
 ...
 * @return
 */
D3DXINLINE D3DXVECTOR4 *D3DXVec4Normalize(D3DXVECTOR4 *pOut, const D3DXVECTOR4 *pV)
{
#ifdef D3DX_NORMALIZATION_POINTER_CHECK
    if (pOut == NULL) {
 ...
 * @return
 */
D3DXINLINE float D3DXVecDistance(const D3DXVECTOR2 *a, const D3DXVECTOR2 *b)
{
    D3DXVECTOR2 c;
    c.x = a->x - b->x;
    c.y = a->y - b->y;
 ...
 * @return
 */
D3DXINLINE float D3DXVecDistance(const D3DXVECTOR3 *a, const D3DXVECTOR3 *b)
{
    D3DXVECTOR3 c;
    c.x = a->x - b->x;
    c.y = a->y - b->y;
 ...
 * @return
 */
D3DXINLINE float D3DXVecDistanceSq(const D3DXVECTOR2 *a, const D3DXVECTOR2 *b)
{
    D3DXVECTOR2 c;
    c.x = a->x - b->x;
    c.y = a->y - b->y;
 ...
 * @return
 */
D3DXINLINE float D3DXVecDistanceSq(const D3DXVECTOR3 *a, const D3DXVECTOR3 *b)
{
    D3DXVECTOR3 c;
    c.x = a->x - b->x;
    c.y = a->y - b->y;
 ...
 * @return
 */
D3DXINLINE D3DXVECTOR3 D3DXFloat2Vec3(float vec[3])
{
 ...
 * @return
 */
D3DXINLINE bool D3DXVec3Similar(const D3DXVECTOR3 *a, const D3DXVECTOR3 *b)
{
    D3DXVECTOR3 tmp = *a - *b;
