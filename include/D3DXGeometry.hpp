 ...
 */
D3DXINLINE D3DXVECTOR3 *D3DXTriangleNormal(D3DXVECTOR3 *pOut, const D3DXVECTOR3 *p1, const D3DXVECTOR3 *p2, const D3DXVECTOR3 *p3)
{
    D3DXVECTOR3 a, b;
    a.x = p1->x - p2->x;
    a.y = p1->y - p2->y;
 ...
 * @return It returns the normal of the triangle (p1, p2, p3).
 */
D3DXINLINE D3DXVECTOR3 *D3DXTriangleNormal2(D3DXVECTOR3 *pOut, const D3DXVECTOR3 *p1, const D3DXVECTOR3 *p2, const D3DXVECTOR3 *p3)
{
    D3DXVECTOR3 a, b;
    a.x = p1->x - p2->x;
    a.y = p1->y - p2->y;
 ...
 * @return
 */
D3DXINLINE float D3DXTriangleArea(D3DXVECTOR3 *v0, D3DXVECTOR3 *v1, D3DXVECTOR3 *v2)
{
 ...
 * @return
 */
D3DXINLINE float D3DXTriangleArea(float v01, float v02, float v12)
{
    float s = (v01 + v02 + v12) / 2.0f;
 ...
 * @return
 */
D3DXINLINE D3DXVECTOR3 D3DXVec2ToVec3(D3DXVECTOR2 *vec)
{
    D3DXVECTOR3 ret;
 ...
 * @return
 */
D3DXINLINE float D3DXVec3DistanceRayPoint(const D3DXVECTOR3 *rO, const D3DXVECTOR3 *rD, const D3DXVECTOR3 *p)
{
 ...
 * @return
 */
D3DXINLINE float D3DXVec3DistanceRayPointF(const D3DXVECTOR3 *rO, const D3DXVECTOR3 *rD, const D3DXVECTOR3 *p)
{
 ...
 * @return
 */
D3DXINLINE D3DXVECTOR3 *D3DXVec3Diffuse(float u1, float u2, D3DXVECTOR3 *out)
{
 ...
 * @return
 */
D3DXINLINE D3DXVECTOR3 *D3DXVec3Reflect(const D3DXVECTOR3 *dir, const D3DXVECTOR3 *nor, D3DXVECTOR3 *out)
{
    if (out == NULL) {
        out = new D3DXVECTOR3();
    }
 ...
 * @return
 */
D3DXINLINE D3DXVECTOR3 *D3DXVec3ReflectNeg(const D3DXVECTOR3 *dir, const D3DXVECTOR3 *nor, D3DXVECTOR3 *out)
{
#ifdef D3DX_POINTER_CHECK
    if (out == NULL) {
        out = new D3DXVECTOR3();
 ...
 * @return
 */
D3DXINLINE bool D3DXVec3Refract(const D3DXVECTOR3 *dir, const D3DXVECTOR3 *nor, float n1, float n2, D3DXVECTOR3 *out)
{
    D3DXVECTOR3 I = (*dir);
    D3DXVECTOR3 N = (*nor);
 ...
 * @return
 */
D3DXINLINE bool D3DXVec3RefractNeg(const D3DXVECTOR3 *dir, const D3DXVECTOR3 *nor, float n1, float n2, D3DXVECTOR3 *out)
{
    D3DXVECTOR3 I = (*dir);
    D3DXVECTOR3 N = (*nor);
